...
const VARIANT_STYLES: Record<ToastVariant, string> = {
  success: "bg-emerald-50 dark:bg-emerald-950/80 border-emerald-100 dark:border-emerald-900 text-emerald-700 dark:text-emerald-400",
  error: "bg-red-50 dark:bg-red-950/80 border-red-100 dark:border-red-900 text-red-700 dark:text-red-400",
